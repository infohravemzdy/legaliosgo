...
func TestHoursToHalfHoursUpShouldReturnRoundedDecimal(t *testing.T) {
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			_sut := EmptyPropsSalary()

			decimalRounds := _sut.HoursToHalfHoursUp(decimalTarget)
...
func TestHoursToQuartHoursUpShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.HoursToQuartHoursUp(decimalTarget)
...
func TestHoursToHalfHoursDownShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.HoursToHalfHoursDown(decimalTarget)
...
func TestHoursToQuartHoursDownShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.HoursToQuartHoursDown(decimalTarget)
...
func TestHoursToHalfHoursNormShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.HoursToHalfHoursNorm(decimalTarget)
...
func TestHoursToQuartHoursNormShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.HoursToQuartHoursNorm(decimalTarget)
...
func TestMoneyToRoundDownShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.MoneyToRoundDown(decimalTarget)
...
func TestMoneyToRoundUpShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.MoneyToRoundUp(decimalTarget)
...
func TestMoneyToRoundNormShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := _sut.MoneyToRoundNorm(decimalTarget)
