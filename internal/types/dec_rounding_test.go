...
func TestDecRoundUpShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	}
	testExamples := []testSpecParams {
		{ "test_pos_55_6", "5,5", "6" },
		{ "test_pos_25_3", "2,5", "3"},
		{ "test_pos_16_2", "1,6", "2"},
		{ "test_pos_11_2", "1,1", "2"},
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			decimalTarget, targetErr := decimal.NewFromString(strings.Replace(tt.testTarget,",",".", -1))
			decimalResult, resultErr := decimal.NewFromString(strings.Replace(tt.testResult, ",",".", -1))

			if targetErr != nil {
				t.Errorf("Target cannot make Decimal from: %s", tt.testTarget)
			}
			if resultErr != nil {
				t.Errorf("Result cannot make Decimal from: %s", tt.testResult)
			}
			decimalRounds := DecRoundUp(decimalTarget)

			if decimalRounds.Equal(decimalResult)==false {
				t.Errorf("Rounding operation failed; expected: %s, actual: %s", decimalResult, decimalRounds)
			}
		})
	}
}

func TestDecRoundDownShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundDown(decimalTarget)
...
func TestDecRoundNormShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundNorm(decimalTarget)
...
func TestDecNearRoundUpShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecNearRoundUp100(decimalTarget)
...
func TestDecNearRoundDownShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecNearRoundDown100(decimalTarget)
...
func TestDecRoundUp50ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundUp50(decimalTarget)
...
func TestDecRoundUp25ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundUp25(decimalTarget)
...
func TestDecRoundUp01ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundUp01(decimalTarget)
...
func TestDecRoundDown50ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundDown50(decimalTarget)
...
func TestDecRoundDown25ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundDown25(decimalTarget)
...
func TestDecRoundDown01ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundDown01(decimalTarget)
...
func TestDecRoundNorm50ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundNorm50(decimalTarget)
...
func TestDecRoundNorm25ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundNorm25(decimalTarget)
...
func TestDecRoundNorm01ShouldReturnRoundedDecimal(t *testing.T) {
	type testSpecParams struct {
		title string
		testTarget string
		testResult string
	...
	for _, tt := range testExamples {
		t.Run(tt.title, func(t *testing.T) {
			...
			decimalRounds := DecRoundNorm01(decimalTarget)
